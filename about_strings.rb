...
It was the worst of times.
    ...
    assert_equal "\n", long_string[0,1]   #结果正确,[0,1]表示字符串的第一位，转行符号
  end
...
EOS
    ...
    assert_equal "I", long_string[0,1]    #结果正确,[0,1]表示字符串的第一位
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # plus equals operator (+=) when building up strings.  Why?  不用另外赋值了？？？
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    string = "Bacon, lettuce and tomato"
    # assert_equal 97, string[1]  #字母 a 的ASCII码就是97
